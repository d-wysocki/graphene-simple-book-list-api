...
unhandled_errors_logger = logging.getLogger("book_list.graphql.errors.unhandled")
handled_errors_logger = logging.getLogger("book_list.graphql.errors.handled")
...
class GraphQLView(View):
    ...
    HANDLED_EXCEPTIONS = (GraphQLError, )
